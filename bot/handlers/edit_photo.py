...
async def start_edit_photo(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        "<b>✏️ Редактирование фото по промту</b>\n\n"
        "Отправьте фотографию, которую хотите отредактировать.\n\n"
        "После загрузки фото вы сможете описать, какие изменения нужно внести.\n\n"
        "📸 Отправьте фото:",
...
async def receive_photo_for_edit(message: Message, state: FSMContext, bot: Bot):
    ...
    try:
        ...
        await message.answer(
            ...
            "• <i>Добавь мягкие тени</i>\n"
            "• <i>Улучши освещение</i>\n"
            "• <i>Сделай цвета ярче</i>\n"
            "• <i>Добавь текст 'СКИДКА 50%' красным цветом</i>\n"
            "• <i>Убери лишние объекты на фоне</i>\n\n"
